(function() {
  ...
  const settings = {
    headerColor: currentScript?.getAttribute('data-header-color') || '#60a5fa',
    headerTextColor: currentScript?.getAttribute('data-header-text-color') || '#1e293b',
    buttonColor: currentScript?.getAttribute('data-button-color') || '#2563eb',
    poweredByText: currentScript?.getAttribute('data-powered-by-text') || 'Powered by Accessibility Widget',
    poweredByColor: currentScript?.getAttribute('data-powered-by-color') || '#64748b'
  };
  ...
  // Save preferences when features are toggled
  featureButtons.forEach(button => {
